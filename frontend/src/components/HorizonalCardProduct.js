                   ...
                   <div className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex'>
                           ...
                           <div className='p-4 grid gap-1 w-full'>
                                ...
                                <div className='flex gap-3'>
                                   ...
                                   <button className='text-md text-white rounded-full cursor-pointer px-3 py-0.5 w-full  bg-slate-200 animate-pulse'></button>
                ...
                return (
                   <Link to={"product/"+product?._id} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex'>
                           <div className='bg-slate-200 h-full p-4 min-w-[120px] md:min-w-[145px]'>
                               <img src={product.productImage[0]} alt={product?.category} className='object-scale-down h-full hover:scale-110 transition-all cursor-pointer'/>
                           ...
                           <div className='p-4 grid gap-1'>
                                ...
                                <div className='flex gap-3'>
                                   ...
                                   <button className='text-md bg-red-600 hover:bg-red-700 text-white rounded-full cursor-pointer px-3 py-0.5' onClick={(e)=> handleAddToCart(e,product._id)}>Add to Cart</button>
